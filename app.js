...
var editTask=function(){
  ...
  var editInput=listItem.querySelector('.todo-app__field_input');
  var label=listItem.querySelector(".todo-app__field_label");
  ...
  listItem.classList.toggle("todo-app__item_edit");
};
